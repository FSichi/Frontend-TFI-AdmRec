...
export const ProyectoScreen = ({ history }) => {
    ...
    const { nombre, descripcion, duracion, cotizacion, estado, fechaInicio, fechaFin, ClienteId } = proyecto;
    ...
    const { nom, des, dur, cot, fInicio, fFin } = formValues;
                                ...
                                (!actualizarState)
                                    ...
                                    (
                                        <div className="row mt-1 ms-5 me-5">
                                            ...
                                            <div className="col-md-12 mb-3">
                                                ...
                                                <input type="text" className="form-control fw-bold" disabled value={cotizacion} style={{ background: '#40efac' }} />
                                            </div>
                                            <div className="col-md-12 mb-3">
                                            ...
                                            <div className="col-md-12 mb-5">
                                                ...
                                                <input type="text" className="form-control" disabled value={fechaFin} />
                                            </div>
                                    ...
                                    (
                                        <div className="row mt-1 ms-5 me-5">
                                            ...
                                            <div className="col-md-12 mb-5">
                                                <span className="fs-5">Fecha de Finalizacion</span>
                                                <input type="date" className="form-control" name='fFin' value={fFin} onChange={handleInputChange} />
                                            </div>
